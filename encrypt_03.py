...
image_in_filename = input_filename('Entrez le path de image :')
...
message = input_text('Entrez le message :', max_length)

image_out_filename = input_new_filename('Entrez le nom du fichier :')
